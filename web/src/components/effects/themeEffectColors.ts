...
const DITHER_PRESETS: Record<Theme, Record<BackgroundTint, DitherPreset>> = {
  ...
  light: {
    indigo: { values: { waveSpeed: 0.04, waveAmplitude: 0.11, backgroundColor: '#c8ccd0', waveColor: '#5046eb', waveFrequency: 0.5, colorNum: 7, mouseRadius: 0.15, disableAnimation: false }, invertColors: false, opacity: 0.51 },
    violet: { values: { waveSpeed: 0.04, waveAmplitude: 0.11, waveFrequency: 0.5, colorNum: 7, mouseRadius: 0.15, waveColor: '#892fdb', backgroundColor: '#cbcfd3', disableAnimation: false }, invertColors: false, opacity: 0.64 },
    teal: { values: { waveSpeed: 0.04, waveAmplitude: 0.11, waveFrequency: 0.5, colorNum: 7, mouseRadius: 0.15, waveColor: '#079990', backgroundColor: '#d2d6db', disableAnimation: false }, invertColors: false, opacity: 1 },
    rose: { values: { waveSpeed: 0.04, waveAmplitude: 0.11, waveFrequency: 0.5, colorNum: 7, mouseRadius: 0.15, waveColor: '#f0134d', backgroundColor: '#e7ecf1', disableAnimation: false }, invertColors: false, opacity: 0.51 },
    amber: { values: { waveSpeed: 0.04, waveAmplitude: 0.11, waveFrequency: 0.5, colorNum: 7, mouseRadius: 0.15, waveColor: '#f6700e', backgroundColor: '#ecf1f6', disableAnimation: false }, invertColors: false, opacity: 0.51 },
  },
};
