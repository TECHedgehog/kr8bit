import { memo, useCallback, useEffect, useMemo, useRef, type CSSProperties, type HTMLAttributes } from 'react';
import { Color, Mesh, Program, Renderer, Triangle } from 'ogl';

import './FaultyTerminal.css';
import { useTileVisible } from '../../hooks/useTileVisible';

// Adapted from react-bits (reactbits.dev) FaultyTerminal — MIT + Commons Clause.
// https://github.com/DavidHDev/react-bits — snapshot of src/content, converted to TS.
// Offscreen tiles skip the WebGL render (playground runs several effects at once).
...
export const FaultyTerminal = memo(function FaultyTerminal({
  scale = 1,
  gridMul = [2, 1],
  digitSize = 1.5,
  timeScale = 0.3,
  ...
  return (
    <div
      ref={containerRef}
      className={`rb-faulty-terminal-container ${className ?? ''}`}
      style={style}
      {...rest}
    />
  );
