...
// Adapted from react-bits (reactbits.dev) LightRays — MIT + Commons Clause.
...
void main() {
  ...
  gl_FragColor  = color;
      ...
      const uniforms = {
        ...
        rayPos: { value: [0, 0] as number[] },
        rayDir: { value: [0, 1] as number[] },
        ...
        mousePos: { value: [0.5, 0.5] as number[] },
