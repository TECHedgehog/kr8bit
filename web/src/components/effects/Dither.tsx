...
import { memo, forwardRef, useEffect, useRef, type ForwardRefExoticComponent, type PropsWithoutRef, type RefAttributes } from 'react';
...
class RetroEffectImpl extends Effect {
  constructor() {
    ...
    // The Effect constructor stores options.uniforms on the instance.
...
// wrapEffect's generic can't infer props from a no-arg constructor —
// type the wrapped component explicitly.
const WrappedRetro = wrapEffect(RetroEffectImpl) as ForwardRefExoticComponent<
  PropsWithoutRef<{ colorNum?: number; pixelSize?: number }> &
    RefAttributes<RetroEffectImpl>
>;
...
const RetroEffect = memo(
  forwardRef<RetroEffectImpl, RetroEffectProps>(function RetroEffect(
    { colorNum, pixelSize },
    ref
  ) {
...
export const Dither = memo(function Dither({
  waveSpeed = 0.05,
  waveFrequency = 3,
  waveAmplitude = 0.3,
