...
// Adapted from react-bits (reactbits.dev) Ferrofluid — MIT + Commons Clause.
...
// its mouse glow when mounted in the pointer-events: none global layer.
...
export const Ferrofluid = memo(function Ferrofluid({
  className,
  dpr,
  paused = false,
    ...
    return () => {
      ...
      const callIfFn = (obj: unknown, key: string) => {
        ...
        if (typeof fn === 'function') {
          (fn as (this: unknown) => void).call(obj);
        }
      };
