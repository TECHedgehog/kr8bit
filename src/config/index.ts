...
const schema = z.object({
  ...
  DEMO_GAME_COUNT: z.coerce.number().int().positive().default(50),
  DEMO_STEAM_DELAY_MS: z.coerce.number().int().nonnegative().default(250),
...
export const config = {
  ...
  demoGameCount: parsed.data.DEMO_GAME_COUNT,
